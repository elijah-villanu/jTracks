...
- [ ] **B1 — FastAPI project scaffolding** (S)
...
- [ ] **B4 — Per-user data isolation dependency** (S)
...
- [ ] **B6 — Status-transition validation** (S)
...
- [ ] **B11 — Spike: Workday parsing feasibility** (M, decision task)
...
- [ ] **B14 — Dashboard stats endpoint** (M)
...
- [ ] **B15 — Spike: recap image generation approach** (S, decision task)
...
- [ ] **B16 — Recap endpoint** (M, scope set by B15)
...
- [ ] **B17 — Deployment configuration** (S)
