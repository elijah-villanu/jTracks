...
- [ ] **D1 — Set up PostgreSQL + SQLAlchemy + Alembic scaffolding** (S)
...
- [ ] **D3 — `applications` table & migration** (M)
...
- [ ] **D4 — Indexes for common query patterns** (S)
...
- [ ] **D6 — Decide data-retention policy for closed applications** (S, decision task)
